...
import numpy as np
import pickle
career = pd.read_csv(r'C:\Users\akalamri\Downloads\MINI PROJECT\CODE\INTELLIGENT-CAREER-GUIDANCE-SYSTEM-main\INTELLIGENT-CAREER-GUIDANCE-SYSTEM-main\dataset9000.data', header = None)
#np.dtype('float64')
